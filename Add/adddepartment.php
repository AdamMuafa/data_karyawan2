...
<div id="app">
    ...
    <div class="form-group" method="POST">
        ...
        <input class="form-control" type="text" placeholder="Id Departement" name="iddepartment">
        <br>
        <label>Nama Departement</label>
        <input class="form-control" type="text" placeholder="Nama Departement" name="namadepartment">
        <br>
        <label>Code Departement</label>
        <input class="form-control" type="text" placeholder="Code Departement" name="codedepartment">
        <br>
        <label>Alamat Department</label>
        <input class="form-control" type="text" placeholder="Alamat Deparment" name="alamatdepartment">
        <br>
        <input class="btn btn-primary" type="submit" value="Add" name="adddepartment">
    ...
    <?php
        ...
        try { 
           $query = "INSERT INTO department(id_department,nama_department,code_department,alamat_department) VALUES('$iddepartment','$namadepartment','$codedepartment','$alamatdepartment')";
       ...
       echo "<script>Swal.fire({
        title: 'Success!',
        text: 'Successfully add Department',
        icon: 'success',
