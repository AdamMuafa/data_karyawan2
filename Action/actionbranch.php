...
<?php
 include_once("../Configure/connection.php");
  ...
  if(isset($_POST['editbranch'])) {
    ...
    $alamatbranch = $_POST['alamat_branch'];
...
try { 
   $query = "UPDATE branch SET nama_branch='$namabranch',code_branch='$codebranch',alamat_branch='$alamatbranch' WHERE id_bank = $idbranch3;";
