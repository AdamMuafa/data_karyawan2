...
<div id="app">
    ...
    while($user_data = mysqli_fetch_array($tampiledit))
    {
        ...
        $namakaryawan1 = $user_data['nama_karyawan'];
        $alamatkaryawan1 = $user_data['alamat_karyawan'];
    }
...
<form method="POST" action="../Action/actionkaryawan.php">
    <div class="form-group" method="POST">
        ...
        <input class="form-control" type="text" value="<?php echo $idkaryawan2 ?>" name="idkaryawan" readonly>
        <br>
        ...
        <input class="form-control" type="text" value="<?php echo $namakaryawan1 ?>" name="namakaryawan">
        <br>
        <label>Alamat Karyawan</label>
        <input class="form-control" type="text" value="<?php echo $alamatkaryawan1 ?>" name="alamatkaryawan">
        <br>
        <input class="btn btn-primary" type="submit" value="Update" name="editkaryawan">
