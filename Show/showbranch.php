...
<!-- <script src="../Template/dist/assets/modules/sweetalert/sweetalert.min.js"></script> -->
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="showbank.php">Bank</a></li>
                <li class=active><a class="nav-link" href="showbranch.php">Branch</a></li>
              </ul>
            </li>
        </aside>
      </div>
