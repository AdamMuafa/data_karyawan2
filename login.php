...
<head>
  ...
  <title>Login &mdash; U N I O N .</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="Template/dist/assets/modules/bootstrap-social/bootstrap-social.css">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-dark">
              ...
              <div class="card-body">
                <form method="POST" action="Configure/authentication.php">
